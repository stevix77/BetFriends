...
internal class FakeMemberRepository : IMemberRepository
{
    ...
    public FakeMemberRepository()
    {
        members = new() 
        { 
            Member.FromState(new MemberState(Guid.Parse("11111111-1111-1111-1111-111111111111"), "username", 2000, 3)),
            Member.FromState(new MemberState(Guid.Parse("adadadad-1111-6666-4444-edededededed"), "toto", 2000, 3)),
